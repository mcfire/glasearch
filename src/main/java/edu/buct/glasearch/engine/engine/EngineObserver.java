package edu.buct.glasearch.engine.engine;
...
public interface EngineObserver {
     ...
     * @see edu.buct.glasearch.engine.engine.EngineObserver#USED
     * @see edu.buct.glasearch.engine.engine.EngineObserver#UNUSED
     */
