...
package edu.buct.glasearch.search.engine;

import edu.buct.glasearch.search.engine.engine.Engine;
import edu.buct.glasearch.search.engine.engine.LeastUsedWeightingStrategy;
import edu.buct.glasearch.search.engine.engine.ProportionWeightingStrategy;
...
//                    searcher = ImageSearcherFactory.createWeightedSearcher(50, colorHist, colorDist, texture); //.createSimpleSearcher(10);
    ...
    public BufferedImage getMosaic(BufferedImage origImg, Dimension mainframe, Dimension raster, 
    		float colh, float cold, float tex, 
    		String indexPath) {
...
//					scaled = this.scale(result, perc);
                    ...
                    //TODO progress progress.setProgress((int) (100 * ((float) (i * splitted.length + j + 1)) / steps));
